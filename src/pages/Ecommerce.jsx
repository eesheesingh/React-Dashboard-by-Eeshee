  ...
  return (
    <div  className='mt-12'>
        ...
        bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>63,448.78 Rs</p>
            </div>
          </div>
          <div className='mt-6'>
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        ...
        dark:bg-secondary-dark-bg m-3 p-4 rounded-xl md:w-780'>
          <div className='flex justify-between'>
            <p className='font-semibold text-xl'>Revenue Updates</p>
            <div className='flex items-center gap-4'>
              <p className='flex items-center gap-2 text-gray-600 hover:drop-shadow-sm-xl'>
                <span><GoPrimitiveDot /></span>
                <span>Expense</span>
              </p>

              <p className='flex items-center gap-2 text-green-600 hover:drop-shadow-sm-xl'>
                <span><GoPrimitiveDot /></span>
                <span>Budget</span>
              </p>
            </div>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>93,692 Rs</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>48,692 Rs</span>
